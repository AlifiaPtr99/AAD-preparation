...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val titlePager : TextView = itemView.findViewById(R.id.tv_title_pager)
        private val startTimePager : TextView = itemView.findViewById(R.id.tv_start_time_pager)
        private val ivPriority: ImageView = itemView.findViewById(R.id.priority_level)
        private val minutesPager : TextView = itemView.findViewById(R.id.tv_minutes_pager)
        private val btnStartCountDown: Button = itemView.findViewById(R.id.btn_open_count_down)
        fun bind(pageType: PageType, pageData: Habit) {
            titlePager.text = pageData.title
            startTimePager.text = pageData.startTime
            minutesPager.text = pageData.minutesFocus.toString()
